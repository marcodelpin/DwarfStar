...
.PHONY: all help clean test test-metal-session-batch test-mxfp4-cuda test-cuda-session-batch test-cuda-mixed-batch dspark-acceptance dspark-verify-depth mtp-verify-depth cpu cuda cuda-spark cuda-generic cuda-regression test-cuda-router-general strix-halo rocm
...
cuda-regression: tests/cuda_long_context_smoke tests/test_cuda_ordered_f16_dispatch tests/test_cuda_router_general
